...
All notable additions and changes to this curated list are documented here.
...
- GitHub Actions workflow for Markdown linting and link validation on every push and pull request.
- Community files: `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `SECURITY.md`, `SUPPORT.md`, `ATTRIBUTIONS.md`, `CODEOWNERS`.
- Project documentation: `docs/PROJECT_SCOPE.md`, `docs/MAINTENANCE.md`, `docs/RESEARCH_SOURCES.md`.
